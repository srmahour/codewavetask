...
export default function CreatePost({modalAction}){
    return(
        <section className=" bg-primary-500 border-2 border-solid border-primary-400 rounded-lg p-5 h-[223px] mb-4">
            ...
            <button type="button" onClick={modalAction} className="bg-secondary h-[43px] w-[111px] text-white text-base leading-5 rounded block ml-auto font-medium">Post</button>
        </section>
    )
}
